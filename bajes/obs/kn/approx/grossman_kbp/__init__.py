...
class korobkin_barnes_grossman_perego_et_al_two_nrfit_isotropic_sec_wrapper(KorobkinBarnesGrossmanPeregoEtAl):
    ...
    def __init__(self, times, lambdas, v_min=1.e-7, n_v=400, t_start=1., **kwargs):
        ...
        self.components     = [Shell(name='dynamics',    geom='isotropic',   time=times,
                                     angles=angles, omegas=omegas,      heat=heat,
                                     v_min=v_min,   n_v=n_v),
                               Shell(name='secular',   geom='isotropic',   time=times,
                                     angles=angles, omegas=omegas,      heat=heat,
                                     v_min=v_min,   n_v=n_v)]
...
class korobkin_barnes_grossman_perego_et_al_two_nrfit_equatorial_polar_wrapper(KorobkinBarnesGrossmanPeregoEtAl):
    ...
    def __init__(self, times, lambdas, v_min=1.e-7, n_v=400, t_start=1., **kwargs):
        ...
        self.components     = [Shell(name='dynamics',  geom='equatorial',   time=times,
                                     angles=angles,     omegas=omegas,      heat=heat,
                                     v_min=v_min,   n_v=n_v),
                               Shell(name='secular',  geom='polar',   time=times,
                                     angles=angles,     omegas=omegas,      heat=heat,
                                     v_min=v_min,   n_v=n_v)]
...
class korobkin_barnes_grossman_perego_et_al_two_joint_grb_isotropic_wrapper(KorobkinBarnesGrossmanPeregoEtAl):
