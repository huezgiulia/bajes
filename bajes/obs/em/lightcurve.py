...
class Lightcurve(object):
    ...
    def __init__(self, times, lambdas, approx, **kwargs):
        ...
        self.times      = times
        self.nus        = lambdas
        self.lambdas    = {k: CLIGHT_SI / v for k, v in lambdas.items()}
        ...
        logger.info("Setting {} lightcurve ...".format(self.approx_grb))
        ...
        self.light_func_grb = __get_lightcurve_generator__(self.approx_grb, self.times, self.nus, **kwargs)
    ...
    def compute_mag(self, params):
        ...
        mag_kn  = self.light_func(self.times+1187008857, params)
